...
class SatMap:
    ...
    def __init__(self, _parameters):
        # if 'File_Is_From_Lir':
        #     self.data, self.meta = Lir().extract_data(_Parameters)

        # elif 'File_Is_From_Manannan':
        #     self.data, self.meta = Manannan().extract_data(_Parameters)

        # elif 'File_Is_From_Fand':
        #     self.data, self.meta = Fand().extract_data(_Parameters)

        # else:
        #     raise ValueError("File couldn't be linked to Lir, Manannan or"
        #                      "Fand imagers")
